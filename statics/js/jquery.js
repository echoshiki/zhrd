...
function sAlert(str){
            ...
            msgObj.style.font="microsoft yahei, Verdana, Geneva, Arial, Helvetica, sans-serif";
          ...
          msgObj.style.marginTop="-75px";
          msgObj.style.marginLeft="-175px";
          msgObj.style.borderRadius="5px";
          msgObj.style.boxShadow="0 0 30px 0 rgba(0, 0, 0, 0.1)";
          ...
          title.innerHTML="<img src='/images/ih-front/im/tcclose1.png' style='margin-right:6px;margin-top:6px;'>";
